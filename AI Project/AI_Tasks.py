...
name_textbox = Entry(root, width=40, fg="#000", bg="#fff")

sid_label = Label(root, text="Student ID:")
sid_textbox = Entry(root, width=40, fg="#000", bg="#fff")

task_label = Label(root, text="Your Task:")
task_textbox = Entry(root, width=40, fg="#000", bg="#fff")
task_textbox.config(state=DISABLED)

submit_btn = Button(root, width=10, text="Get Task", command=submit)
exit_btn = Button(root, width=15, text="Exit Program", command=root.quit)

name_label.grid(row=0, column=1)
name_textbox.grid(row=0, column=2)
sid_label.grid(row=1, column=1)
sid_textbox.grid(row=1, column=2)
task_label.grid(row=2, column=1)
task_textbox.grid(row=2, column=2)
